...
public class ModY  extends PDFTextStripper {
    ...
    public static void readContent( String str_file_name) throws IOException    {
        ...
        PrintWriter pw = null;
        //String fileName = "C:/Labo20/NTT��/���H/HTML��/W17-00671.pdf";
        try {
	...
	public static void main(String[] args) {
		...
		//if(args.length>0){
			...
			String str_dir_root ="C:/Labo20/NTT��/���H/pdf_from_doc";
			//File resultFile = new File("C:/Labo20/NTT��/���H/HTML��/W17-00671_test.txt");
